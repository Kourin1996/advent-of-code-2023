...
mod tests {
    ...
    #[test]
    fn example1() {
        assert_eq!(extract_two_digits("1abc2"), 12);
    }

    #[test]
    fn example2() {
        assert_eq!(extract_two_digits("pqr3stu8vwx"), 38);
    }

    #[test]
    fn example3() {
        assert_eq!(extract_two_digits("a1b2c3d4e5f"), 15);
    }

    #[test]
    fn example4() {
        assert_eq!(extract_two_digits("treb7uchet"), 77);
    }
}
